    ...
    72: {
       ...
       buyables: {
        ...
        13: {
            title: "x",
            display() {
                return "Boosts numbers gain by " + format(tmp.N.buyables[13].effect) + "x<br>Cost : " + format(tmp[this.layer].buyables[this.id].cost)
            },
...
addLayer("NN", {
    ...
    15: {
        title: "-5",
        description: "Increase '2', '3', '4' hardcap but nerf them.",
        cost(){
    ...
    milestones: {
        3: {
            ...
            effectDescription(){
              if(player.X.points.gte(1))return "'+', '-', and '/' effect is always the cap"
        ...
        3.14e16: {
            requirementDescription: "3.14e16 Negative number",
...
addLayer("UF", {
    ...
    milestones: {
        ...
        69: {
            requirementDescription: "69 Upgrade Factor",
            effectDescription: "Challenge points boosts Number gain.",
...
211: {  
    name: "Upgrader gamma",
    challengeDescription: "+ & - is divide instead of multiple.",
...
rewardDescription(){return "+ hardcap is greater."},
...
212: {  
    name: "Upgrader delta",
    challengeDescription: "/ does nothing.",
...
101: {
    ...
    111: {
      title: "Challenged",
      description: "Unlock a new infinity challenge and gain more Numbers based on Infinity. You can buy this upgrade while you are in Infinity challenge 7." ,
      cost(){
...
addLayer("I", {
    ...
    milestones: {
        ...
        4: {
            ...
            effectDescription(){
              if(player.X.points.gte(1))return "keep Factor Upgrade, Negative number Upgrade and Negative number milestone on reset, Negative number x10, and unlock new challenges to explore."
              return "keep Factor Upgrade, Negative number Upgrade and Negative number milestone on reset, Negative number x10."
            },
        ...
        5: {
            ...
            effectDescription(){
              if(player.X.points.gte(1))return "x1.1 Negative number per Infinity and keep challenge point on reset."
              return "Unlock more challenge."
            },
