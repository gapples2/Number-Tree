...
if (hasUpgrade('MS',13)&&!hasUpgrade('MS',42))mult = mult.times(player.MS.x.pow(100))
    ...
    milestones: {
        1: {
            ...
            effectDescription: "Keep '0' and Factor challenges on reset.",
            done() { return player.IP.points.gte(1) }
        },
        2: {
            requirementDescription: "2 IP",
            effectDescription: "Keep negative number upgrades and milestones on reset.",
            done() { return player.IP.points.gte(2) }
        },
        4: {
            requirementDescription: "3 IP",
            effectDescription: "Keep Factor upgrades and milestones on reset.",
            done() { return player.IP.points.gte(3) }
        },
        6: {
            requirementDescription: "4 IP",
            effectDescription: "gain 100% of negative numbers on reset per second and keep UF milestones on reset.",
            done() { return player.IP.points.gte(4)||hasMilestone("MS", 2) }
        },
        26: {
            requirementDescription: "1e26 IP",
            effectDescription: "Factors are cheaper.",
            done() { return player.IP.points.gte(1e26) }
        },
        10000: {
            requirementDescription: "1e10000 IP",
            effectDescription: "Raise NN gain to 1.05",
            done() { return player.IP.points.gte("1e10000") }
        },
        17000: {
            requirementDescription: "1e17000 IP",
            effectDescription: "Unlock Exponentiation.",
            done() { return player.IP.points.gte("1e17000") }
        },
        20000: {
            requirementDescription: "1e20000 IP",
            effectDescription: "Unlock Exponentiation prestige.",
            done() { return player.IP.points.gte("1e20000") }
        },
        38500: {
            requirementDescription: "1e38500 IP",
            effectDescription: "Unlock negative number challenges.",
            done() { return player.IP.points.gte("1e38500") }
        },
        1000000: {
            requirementDescription: "1e1000000 IP",
            effectDescription: "Remove the hardcap of Exponentiation points and prestige points.",
            done() { return player.IP.points.gte("1e1000000") }
        },
        6000000: {
            requirementDescription: "1e6000000 IP",
            effectDescription: "the twelfth IP upgrade has no effect but cube number gain.",
            done() { return player.IP.points.gte("1e6000000") }
        },
        30000000: {
            requirementDescription: "1e30000000 IP",
            effectDescription: "Gain 100% of IP on reset per second",
            done() { return player.IP.points.gte("1e30000000") }
        },
        4.4e12: {
            requirementDescription: "e4.444e12 IP",
    ...
    upgrades:{
        11: {
            title: "UltraLuigi (Easter Eggs 1, 2, 3, and 4)",
            description: "Unlock a negative number buyable.",
            cost: new Decimal(5),
            unlocked(){
                return true
            },
    ...
    12: {
        title: "TrueDiego ΔΔΔ (Easter Eggs 1 and 4)",
        description: "Unlock an IP challenge.",
        cost: new Decimal(10),
        unlocked(){
...
21: {
    title: "JashinFanatic (Easter Eggs 1 and 3)",
    description: "Autobuy the negative number buyable and IP boosts negative number gain.",
    cost: new Decimal(10),
    unlocked(){
        return hasUpgrade('IP',11)
    },
...
22: {
    title: "_lx5=nitro (Easter Eggs 1 and 5)",
...
13: {
    title: "Elund (Easter Eggs 1, 2 and 3)",
...
23: {
    title: "garnet420 (Easter Eggs 1 and 3)",
    description: "Unlock 2 IP challenges.",
...
32: {
    title: "luenix (Easter Eggs 1 and 2)",
    description: "Boost '-4'.",
...
44: {
    ...
    description: "Multiply negative number gain by 1e80000 but '^' and '-+' are useless.",
...
45: {
    ...
    description: "Unlock 2 Infinity challenges.",
...
46: {
    title: "Elliott (Easter Eggs 3 and 4)",
    description: "Boost number gain base by Infinity.",
...
54: {
    ...
    description: "Raise IP gain to 1.1.",
...
55: {
    ...
    description: "Raise IP gain to 1.05.",
...
56: {
    ...
    description: "'Factor Lambda' is useless but raise number gain to 1.75.",
...
64: {
    ...
    description: "Unlock an Infinity challenge.",
...
66: {
    ...
    description: "Unlock a negative number challenge.",
    ...
    challenges:{
        11: {
            name: "Infinity 1",
            challengeDescription: "Raise number gain to 0.9.",
            canComplete(){if(hasChallenge('IP',12)) return player.NN.points.gte("1e1000")
            else return player.NN.points.gte("1.8e308")},
            goalDescription: "1.80e308 negative numbers (1e1000 negative numbers after completing Infinity 2)",
            rewardDescription(){return "Raise negative number gain to 1.1."},
          unlocked(){return hasUpgrade('IP',12)},
        },
          12: {
            name: "Infinity 2",
            challengeDescription: "'-4' is useless.",
            canComplete(){ if(hasChallenge('IP',11)) return player.NN.points.gte("1e1000")
            else return player.NN.points.gte("1.8e308")},
            goalDescription: "1.80e308 negative numbers (1e1000 negative numbers after completing Infinity 1)",
            rewardDescription(){return "Raise negative number gain to 1.15."},
          unlocked(){return hasUpgrade('IP',31)},
        },
        21: {
            name: "Eternity 1",
            challengeDescription: "Raise number gain to 0.5.",
            canComplete(){
                if(hasChallenge('IP',22)) return player.NN.points.gte("1e1000")
                else return player.NN.points.gte("1.8e308")},
            goalDescription: "1.80e308 negative numbers (1e1000 negative numbers after completing Eternity 2)",
            rewardDescription(){return "Raise negative number gain to 1.2."},
        ...
        22: {
            ...
            goalDescription: "1.80e308 negative numbers (1e1000 negative numbers after completing Eternity 1)",
            rewardDescription(){return "Raise negative number gain to 1.25."},
          unlocked(){return hasUpgrade('IP',23)},
        },
        31: {
            name: "Reality 1",
            challengeDescription: "Raise number gain to 0.15.",
            canComplete(){
                if(hasChallenge('IP',32)) return player.NN.points.gte("1e1000")
                else return player.NN.points.gte("1.8e308")},
            goalDescription: "1.80e308 negative numbers (1e1000 negative numbers after completing Reality 2)",
            rewardDescription(){return "Raise number gain to 1.3."},
          unlocked(){return hasUpgrade('IP',33)},
        },
        32: {
            name: "Reality 2",
            challengeDescription: "'-2', '-3', and '-4' is useless.",
            canComplete(){
                if(hasChallenge('IP',31)) return player.NN.points.gte("1e1000")
                else return player.NN.points.gte("1.8e308")},
            goalDescription: "1.80e308 negative numbers (1e1000 negative numbers after completing Reality 1)",
            rewardDescription(){return "Raise number gain to 1.35."},
          unlocked(){return hasUpgrade('IP',33)},
        },
    },
    clickables: {
        11:{
            display() {return "Reset Infinity challenges."},
            canClick(){return !(hasChallenge('IP',11)&&hasChallenge('IP',12))},
            onClick(){player.IP.challenges[11] = 0
                player.IP.challenges[12] = 0 }
            },
        12:{
        display() {return "Reset Eternity challenges."},
        canClick(){return !(hasChallenge('IP',21)&&hasChallenge('IP',22))},
        onClick(){player.IP.challenges[21] = 0
            player.IP.challenges[22] = 0 }
        },
        13:{
            display() {return "Reset Reality challenges."},
