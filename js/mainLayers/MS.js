addLayer("MS", {
    ...
    milestones: {
        1: {
            requirementDescription: "1 MS",
            effectDescription: "Autobuy number upgrades and Factor upgrades, multiply number & point by 1e20, FS resets nothing, and unlock an Infinity challenge.",
            done() { return player.MS.points.gte(1) }
        },
        2: {
            requirementDescription: "2 MS",
            effectDescription: "Keep the fourth IP milestone, the fourth Factor milestone, '16', and the fifth & sixth UF milestone on reset. Raise IP gain to 1.1 and remove the hardcap for NN gain.",
            done() { return player.MS.points.gte(2) }
        },
        3: {
            requirementDescription: "3 MS",
            effectDescription: "Keep Factor content and Infinity milestones on reset and IP boosts point gain.",
            done() { return player.MS.points.gte(3) }
        },
        4: {
            requirementDescription: "1 PP",
            effectDescription: "Boost X & Y gain by prestige points and double X & Y gain.",
            done() { return player.MS.Prestige.gte(1) }
        },
        8: {
            requirementDescription: "8 PP",
            effectDescription: "You can't gain any more prestige points.",
            done() { return player.MS.Prestige.gte(8) }
        },
        40: {
            requirementDescription: "4 MS",
            effectDescription: "Raise IP gain to 1.1, unlock an Infinity challenge, autobuy FS, and multiply number gain by 10.",
            done() { return player.MS.points.gte(4) }
        },
        41: {
            requirementDescription: "1 SPP.",
            effectDescription: "Super prestige points boost X and Y gain and add 1 to Y gain.",
            done() { return player.MS.Prestige2.gte(1) }
        },
        42: {
            requirementDescription: "2 SPP.",
            effectDescription: "Start with 25 prestige points on SP reset and unlock an upgrade. You can't gain any more super prestige points.",
            done() { return player.MS.Prestige2.gte(2) }
        },
        55: {
            requirementDescription: "5 SPP.",
            effectDescription: "Start with 100 prestige points on SP reset.",
            done() { return player.MS.Prestige2.gte(5) }
        },
        400: {
            requirementDescription: "40 SPP.",
            effectDescription: "You can't get any more super prestige points and remove the hardcap of exponentiation points.",
            done() { return player.MS.Prestige2.gte(40) }
        },
        500: {
            requirementDescription: "5 MS",
            effectDescription: "Remove IP challenges but raise number gain to 25.",
            done() { return player.MS.points.gte(5) }
        },
        600: {
            requirementDescription: "6 MS",
            effectDescription: "MS resets nothing, the UF buyable is cheaper, and gain 100,000% of EP on reset per second ",
            done() { return player.MS.points.gte(6) }
        },
        700: {
            requirementDescription: "7 MS",
            effectDescription: "Unlock z in exponentiation and unlock more exponentiation and UF upgrades.",
            done() { return player.MS.points.gte(7) }
        },
        800: {
            requirementDescription: "8 MS",
            effectDescription: "Unlock Hyper prestige and auto get prestige points.",
            done() { return player.MS.points.gte(8) }
        },
        3000: {
            requirementDescription: "3 HPP",
            effectDescription: "Auto get super prestige point.",
            done() { return player.MS.Prestige3.gte(3) }
        },
        4000: {
            requirementDescription: "10 HPP",
            effectDescription: "Auto get Challenge point and CP boosts super prestige point gain.",
            done() { return player.MS.Prestige3.gte(10) }
        },
        11000: {
            requirementDescription: "11 MS with F6.1 upgrade",
            effectDescription: "Boost '9' and '0'.",
            done() { return player.MS.points.gte(11)&&hasUpgrade('MS',42) }
        },
        8e29: {
            requirementDescription: "e8e29 IP",
            effectDescription: "Multiply game speed by 10.",
            done() { return player.IP.points.gte("e8e29") },
            onComplete(){ return       player.devSpeed=10 },
        },
        1.7e30: {
            requirementDescription: "e1.7e30 IP",
            effectDescription: "Boost game speed based on IP.",
            done() { return player.IP.points.gte("e1.7e30") },
         
        },
        1.83e36: {
            requirementDescription: "e1.83e36 IP",
            effectDescription: "Boost game speed based on Factors.",
    ...
    upgrades: {
        11: {
            title: "^",
            description: "Gain 1x per second.",
            cost: new Decimal("1"),
        ...
        12: {
            title: "^2",
            description: "Gain 0.01y per second.",
            cost: new Decimal("30"),
            currencyDisplayName: "Exponentiation points",
            currencyLayer:"MS",
            currencyInternalName:"Exponentiation"
        ...
        13: {
            title: "^3",
            description: "IP boosts x gain and x boosts IP gain.",
        ...
        23: {
            title: "^8",
            description: "Raise x gain to 1.25.",
        ...
        25: {
            title: "^10",
            description: "Boost point gain base by exponentiation points and gain 2.5x more x and 1.5x more y.",
        ...
        31: {
            title: "^^1",
            description: "Square point gain and remove the hardcap of IP gain but nerf it.",
        ...
        32: {
            title: "^^2",
            description: "Cube point gain and CP boosts z gain.",
        ...
        33: {
            title: "^^3",
            description: "Cube point gain and boost the sixth milestone.",
        ...
        34: {
            title: "^^4",
            description: "Get more prestige points based on hyper prestige points.",
        ...
        35: {
            title: "^^5",
            description: "Get more z based on Infinity done and unlock a.",
        ...
        42: {
            title: "F6.1",
            description: "Remove Exponentiation but raise number gain to 25, MS is cheaper, and unlock a UF upgrade. Buying this upgrade will reset your MS and IP.",
        ...
        51: {
            title: "Start mult",
            description: "Gain 0.01 mult per second.",
        ...
        52: {
            title: "mult M",
            description: "Mathematicians boost mult gain.",
        ...
        53: {
            title: "mult O",
            description: "Ordinals boost mult gain.",
        ...
        55: {
            title: "True boost",
            description: "Mult boosts number and point gain.",
        ...
        81: {
            title: "add",
            description: "Divide divider costs by 100.",
      ...
      onPurchase(){player.MS.divcost=new Decimal(100)},
        ...
        82: {
            title: "again",
            description: "Divide points will reset to 1e20 and give a subtraction point if it's smaller than 1.",
        ...
        83: {
            title: "True^2 Math",
            description: "Remove Eternity but raise number to 10 and shapes reset nothing.",
        ...
        101: {
            title: "boost",
            description: "Subtraction points boost divider speed and click gain.",
            cost(){ return new Decimal("0")},
        ...
        102: {
            title: "Automation",
            description: "Autoclick the clickable 20 times per second.",
        ...
        103: {
            title: "Alpha cheaper",
            description: "Dividers are 10x cheaper.",
    ...
    clickables:{
            ...
            11:{
                display() {return "Reset x and y for a prestige point (Req: 1e150 Exponentiation points)."},
    ...
    12:{
        display() {return "Reset x, y, prestige points, and MS milestones for a super prestige point (Req: 1e4000 Exponentiation points and 25 prestige points)."},
...
13:{
    display() {return "Reset x, y, z, prestige points, and super prestige points for a hyper prestige point (Req: ee10000 Exponentiation points and 1000 prestige points)."},
...
21:{
    display() {
        if(hasUpgrade('MS',101))   return "Click for " +format(buyableEffect('MS',12).times(new Decimal(1e21).div(player.MS.size).log(10).pow(0.5)).pow(buyableEffect('MS',22)).times(player.MS.minuspoint.add(1)))+ " addition points."
     else   return "Click for " +format(buyableEffect('MS',12).times(new Decimal(1e21).div(player.MS.size).log(10).pow(0.5)).pow(buyableEffect('MS',22)))+ " addition points."},
...
buyables: {
    ...
    12: {
        title: "click booster",
        display() {
           return"Multiply click gain by "+format(buyableEffect('MS',12))+".<br>Cost: " + format(new Decimal("10").pow(getBuyableAmount("MS", 12).add(1).pow(1.25))) + " addition points"
        },
        unlocked() { return hasUpgrade("E", 23)},
        canAfford() { 
    ...
    22: {
        ...
        display() {
           return"Raise click gain to "+format(buyableEffect('MS',22))+".<br>Cost: " + format(new Decimal("1000").pow(getBuyableAmount("MS", 22).add(1).pow(1.2))) + " addition points"
        },
        unlocked() { return hasUpgrade("E", 23)},
        canAfford() { 
