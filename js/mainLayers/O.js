addLayer("O", {
    ...
    effectDescription(){    
        return " which raises number gain to " + format(tmp.O.effect)
   ...
   milestones: {
    1: {
        ...
        effectDescription: "Keep negative number challenges on reset.",
    ...
    4: {
        ...
        effectDescription: "Keep Infinity milestones and challenges on reset.",
        done() { return player.O.points.gte(4) },
    },
    6: {
        requirementDescription: "6 Ordinal",
        effectDescription: "Keep UF upgrades on reset and autobuy UF buyables.",
        done() { return player.O.points.gte(6) },
    },
    9: {
        requirementDescription: "9 Ordinal",
        effectDescription: "Keep IP milestones on reset and Ordinal boosts EP gain.",
        done() { return player.O.points.gte(9) },
    },
    100: {
        requirementDescription: "100 Ordinal",
        effectDescription: "Square number gain and Ordinal boosts CP gain.",
        done() { return player.O.points.gte(100) },
    },
    103: {
        requirementDescription: "3 ω completions",
        effectDescription: "Numbers boost point gain.",
        done() { return challengeCompletions('O',11)>2},
    },
    104: {
        requirementDescription: "150,000 Ordinal",
        effectDescription: "Factors are cheaper and Boost or Nerf boosts IP instead of NN.",
    ...
    369: {
        ...
        effectDescription: "Game speed ^1.01, gain x1e8 more EP, and Mathematicians are cheaper.",
    ...
    challenges:{
        11: {
            ...
            completionLimit(){
                let limit=10;
                if(hasChallenge('E',22)) limit=20
                if(hasMilestone('S',4)) limit=1000
                return limit;
            },
            challengeDescription(){
                return "Number gain ^" + player.O.Goal+"<br>You have completed this challenge "+ challengeCompletions('O',11)+"/"+tmp.O.challenges[11].completionLimit+" times." },
            canComplete(){return player.F.points.gte("1.8e308")},
            goalDescription: "1.8e308 Factors",
            rewardDescription(){return "Boost the sixth Ordinal milestone and raise number gain to "+format(player.O.reward)+"."},
