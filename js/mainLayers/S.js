addLayer("S", {
    ...
    milestones: {
        1: {
            ...
            effectDescription: "Autobuy IP upgrades and keep Eternity, MS milestones, and negative number challenges on reset.",
            done() { return player.S.points.gte(1) }
        },
        2: {
            requirementDescription: "2 Shapes",
            effectDescription: "Keep IP, F, and UF milestones on reset.",
            done() { return player.S.points.gte(2) }
        },
        3: {
            requirementDescription: "3 Shapes",
            effectDescription: "Keep MS and UF upgrades on reset.",
