addLayer("X", {
    ...
    resource(){return false?"xxx":"???"},            // The name of this layer's main prestige resource.
    ...
    requires(){return false?new Decimal("ee160"):new Decimal("ee100")},              // The amount of the base needed to  gain 1 of the prestige currency.
        ...
        "Info": {
            content: [
                ...
                ["display-text",function(){
                    let s=""
                    s+="Tetrates and raises point and number gain to " + new Decimal(1).minus(player.X.points.times(0.05))+" and added new content "+formatWhole(player.X.points)+" times."
